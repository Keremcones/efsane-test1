...
var GTM_CONTAINER_ID = (window.GTM_CONTAINER_ID || window.__ENV_GTM_CONTAINER_ID || '').trim();
window.GTM_CONTAINER_ID = GTM_CONTAINER_ID;
var GA_MEASUREMENT_ID = (window.GA_MEASUREMENT_ID || window.__ENV_GA_MEASUREMENT_ID || '').trim();
...
var APP_CONFIG = window.APP_CONFIG || {
    ...
    backtestDays: 120,
    backtestSlippageBps: 3, // 0.03% each side
    backtestFeeBps: 5, // 0.05% each side
